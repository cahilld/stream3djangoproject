...
dragula([$('taskcolumna'), $('taskcolumnb'), $('taskcolumnc'), $('taskcolumnd')]);
dragula([$('a-copy'), $('b-copy'), $('c-copy'), $('d-copy')], { copy: true });
dragula([$('a-events'), $('b-events'), $('c-events'), $('d-events')])
  .on('drag', function (el) {
...
dragula([$('a-rollbacks'), $('b-rollbacks'), $('c-rollbacks'), $('d-rollbacks')], { revertOnSpill: true });
dragula([$('a-lovehandles'), $('b-lovehandles'), $('c-lovehandles'), $('d-lovehandles')], {
  moves: function (el, container, handle) {
    return handle.className === 'handle';
  }
});

dragula([$('a-rm-spill'), $('b-rm-spill'), $('c-rm-spill'), $('d-rm-spill')], { removeOnSpill: true });
dragula([$('a-copy-1tomany'), $('b-copy-1tomany'), $('c-copy-1tomany'), $('d-copy-1tomany')], {
  copy: function (el, source) {
    return source === $('a-copy-1tomany');
  },
  accepts: function (el, target) {
    return target !== $('a-copy-1tomany');
  }
});
